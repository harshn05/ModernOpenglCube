//g++ -s -o main -O2 main1.cpp -lglfw3 -lglew32 -lopengl32 -lgdi32 -lglu32
#include <GL/glew.h>
...
void main()
{
    ...
    color = vec4(diff, diff, diff, 1.0); // Simple diffuse lighting
}
)";
...
int main()
{
  ...
  GLFWwindow *window = glfwCreateWindow(800, 600, "Voxel Cube", nullptr, nullptr);
  if (window == nullptr)
  {
