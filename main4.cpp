//g++ -s -o main -O2 main4.cpp -lglfw3 -lglew32 -lopengl32 -lgdi32 -lglu32
#include <GL/glew.h>
...
void main()
{
    ...
    vec3 ambient = ambientStrength * vec3(0.5, 0.2, 0.8); // Purple color

    // Diffuse light
    vec3 norm = normalize(fragNormal);
    vec3 lightDir = normalize(lightPos - fragPosition);
    float diff = max(dot(norm, lightDir), 0.0);
    vec3 diffuse = diff * vec3(0.5, 0.2, 0.8); // Purple color
...
int main()
{
  ...
  GLFWwindow *window = glfwCreateWindow(windowWidth, windowHeight, "Voxel Cube", nullptr, nullptr);
  if (window == nullptr)
  {
