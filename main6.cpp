// g++ -s -o main -O2 main6.cpp -lglfw3 -lglew32 -lopengl32 -lgdi32 -lglu32
#include <GL/glew.h>
...
int main()
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    for (int i = 0; i < m; ++i)
    {
      ...
      glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(i * 1.5f - (m - 1) * 0.75f, 0.0f, 0.0f)); // Position cubes side by side
      glUniformMatrix4fv(glGetUniformLocation(shaderProgram, "model"), 1, GL_FALSE, glm::value_ptr(model));

      // Set the color for each cube
      glm::vec3 cubeColor;
      cubeColor = colors.at(i);
      glUniform3f(glGetUniformLocation(shaderProgram, "cubeColor"), cubeColor.r, cubeColor.g, cubeColor.b); // Set the cube color
